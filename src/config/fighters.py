...
class Fighter:
    def __init__(self, name, speed, damage, abilities, color, style, stats, description, combo_tips, lore, special_ability, weakness):
        self.name = name
        self.speed = speed
        self.damage = damage
        ...
        self.hitbox = pygame.Rect(self.x + 5, self.y + 5, 40, 90)
    ...
    def draw(self, screen):
        ...
        health_width = 50 * (self.health / self.stats["Vie"])
