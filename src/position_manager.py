...
class PositionManager:
    ...
    def calculate_layout(self):
        ...
        total_width = (character_count * SETTINGS.CARD_WIDTH) + ((character_count - 1) * SETTINGS.CARD_SPACING)
    ...
    def get_card_position(self, index):
        # Position d'une carte de personnage
    ...
    def update_card_positions(self, fighter_data):
        # Mettre à jour les positions des cartes selon le nombre de personnages
